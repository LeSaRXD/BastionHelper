...
public class KeyInputManager {
	...
	public static String SHOW_LAVA_DEADZONES = "key.bastionhelper.show_lava_deadzones";
	...
	public static void register() {
		KeyBind[] keyBinds = new KeyBind[] {
				...
				new KeyBind(PAUSE_PIGLINS, GLFW.GLFW_KEY_P, ShowPiglinPathsHandler::run),
				new KeyBind(SHOW_LAVA_DEADZONES, GLFW.GLFW_KEY_L, ShowLavaDeadzonesHandler::run),
